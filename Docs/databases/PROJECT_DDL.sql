...
(
  ...
  UNIQUE_ID VARCHAR(500) NOT NULL COMMENT '접근권한 대표값',
  PRIMARY KEY (UNIQUE_ID)
) COMMENT '접근권한명';

CREATE TABLE AUTHS
(
  UNIQUE_ID_AUTH_NAMES VARCHAR(500) NOT NULL COMMENT '접근권한 대표값',
  UNIQUE_ID            VARCHAR(500) NOT NULL COMMENT '유니크ID',
...
(
  ...
  SEX_ID                VARCHAR(500) NOT NULL COMMENT '성별_ID',
...
(
  DISEASE    VARCHAR(500) NOT NULL COMMENT '질병이력',
  ALLERGIES  VARCHAR(500) NOT NULL COMMENT '알레르기',
