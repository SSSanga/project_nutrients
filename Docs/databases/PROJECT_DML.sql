...
(4, NOW(),'해당 제품의 재고가 언제 들어오나요?', '재고는 다음 주에 입고 예정입니다.', '2023-07-23', 'admine', 'MEMB_04'),
(5, NOW(),'천연 성분을 포함한 제품 추천 부탁드려요.', '저희의 천연 성분 비타민D 제품을 추천드립니다.', '2023-07-24', 'admine', 'MEMB_05'),
(6, NOW(),'이 제품의 사용 방법을 알려주세요.', '하루에 한 번, 한 캡슐씩 복용하시면 됩니다.', '2023-07-25', 'admine', 'MEMB_06'),
(7, NOW(),'제품 구매 후 고객 리뷰 작성 방법을 알려주세요.', '구매 확정 후 나타나는 리뷰 작성 창에서 후기를 작성해주시면 됩니다.', '2023-07-26', 'admine', 'MEMB_07'),
(8, NOW(),'제품이 효과가 없는 것 같아요.', '제품의 효과는 개인의 체질에 따라 다르며, 일정 기간 이상 꾸준히 복용해야 보입니다.', '2023-07-27', 'admine', 'MEMB_08'),
(9, NOW(),'제품 복용 시 주의사항은 무엇인가요?', '식사 후에 복용하시고, 알레르기가 있는 성분은 사전에 확인하신 후 복용해주세요.', '2023-07-28', 'admine', 'MEMB_09'),
