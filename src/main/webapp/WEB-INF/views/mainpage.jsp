...
<body>
                ...
                <div class="row p-2">
                    <div class="col-md-3">
                        <button type="submit" class="w-100 btn btn-lg btn-outline"
                            formaction="./administrator/livercare.html">간 기능
                            개선</button>
                    </div>
                    <div class="col-md-3">
                        <button type="submit" class="w-100 btn btn-lg btn-outline"
                            formaction="./administrator/recovery.html">피로
                            회복</button>
                    </div>
                    <div class="col-md-3">
                        <button type="submit" class="w-100 btn btn-lg btn-outline"
                        ...
                        <div id="controlsID-first" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./images/레모나.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img src="./images/pill_3.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img src="./images/pill_4.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img src="./images/이서진루테인.jpg" alt="">
                                </div>
                            </div>
    ...
    <footer class="p-5 d-flex justify-content-between align-items-center font-size: 0.8rem footer-green">
        ...
        <div class="row">
            <img src="./images/drug_img.jpg" alt="logo" height="130rem">
        </div>
