            ...
            <form>
              ...
              <div class="container m-2" style="font-weight: bold;">
                <div class="d-flex m-3 align-items-center">
                  ...
                  <select class="form-select me-2 mt-auto mb-auto" name="search"
                    style="font-size: 18px; width: 180px; height: 50px; font-weight: bold;">
                  ...
                  <input class="form-control me-2 mt-auto mb-auto" style="font-size: 18px; width: 150px; height: 50px; "
                  ...
                  <button class="btn btn-light btn-outline-secondary mt-auto mb-auto" type="submit"
                    ...
                    style="font-size: 18px; width: 100px; height: 50px;" formmethod="get">검색</button>
                </div>
                  ...
                  <% Paginations paginations=(Paginations)result.get("paginations"); %>
                    ...
                    <div class="container content-center me-2 mt-auto mb-auto">
                        ...
                        <tbody class="">
                         <% ArrayList resultList=(ArrayList)result.get("resultList");
                            ...
                            <tr>
                              ...
                              <td class="align-middle">
                                <button class="btn btn-outline" type="submit" formaction='/supp/selectspec/<%= record.get("SUPP_ID") %>' 
                                  value='<%= record.get("SUPP_ID") %>' name='SUPP_ID' id="suppdetail"  style="font-weight: bold;"  type="hidden" formmethod="post">
                                  <%= record.get("PRODUCT") %></button>
                              </td>
                              <td class="align-middle">
