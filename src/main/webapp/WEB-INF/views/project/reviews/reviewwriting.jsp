                ...
                <%@ include file="/WEB-INF/views/project/header.jsp" %>
                    ...
                    <form class="d-flex" action="" method="">
                        ...
                        <div class="container content-center">
                            <div class="h1 text-center " style="font-weight: bold;">Reviews</div>
                            ...
                            <div class="row">
                                <div class="col-md-8 mx-auto">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <input class="form-control" id="content" type="hidden" rows="5"
                                                name="REVIEW_ID">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-3 border rounded p-2" name="UNIQUE_ID"
                                                value="${userDetailsBean.username}">
                                                ${userDetailsBean.memberID} </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="image" class="form-label">이미지 </label>
                                            <input class="form-control" type="file" id="image" value="" rows="5"
                                                name="IMAGES">
                                        </div>
                                        <button type="submit" class="btn btn-outline-secondary"
                                            formaction="/reviews/reviewinsertAndSelect">저장하기</button>
                                    </form>
                                </div>
                            </div>
                        </div>
