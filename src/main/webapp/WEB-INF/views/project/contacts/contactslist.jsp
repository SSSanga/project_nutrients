                    ...
                    <form>
                        ...
                        <main class="container p-3">
                            ...
                            <div class="d-flex align-items-center mx-2">
                                ...
                                <input type="search" name="words" value="" class="form-control me-2 mt-auto mb-auto"
                                    placeholder="Search..."
                                    style="font-size: 25px; width: 150px; height: 50px; font-weight: bold;"
                                    aria-label="Search" id="keydownEnter">
                                <button class="btn btn-light btn-outline-success mt-auto mb-auto font-weight-bold"
                                    type="submit" formaction="/contacts/contactsselectSearch"
