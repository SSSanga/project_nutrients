...
### 💊김하늘
⁉️ 모두 각자의 자리에서 한사람도 부족함 없이 최선을 다해 본인의 역할을 해줘서 너무 고마웠다. 갑자기 sample code를 맡게 되서 막막했지만, 팀원들이 코드에만 집중하게 해줘서 문제없이 해결 할 수 있었다.
서로 설명해주고 에러를 해결하면서 많이 배우고 프로젝트 시작하기 전보다 더 똑똑한 우리팀이 된 것 같다. 모두 탈주하지 말고 2차 프로젝트 까지 함께해요~
